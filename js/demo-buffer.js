...
window.DEMO_BUFFER = {
  alice_companion: {
    ...
    finish: {
      reply: "That was a lovely mini chat! In Alice Modo Libre you can talk anytime, about anything, with the same voice and no cut-offs.\n\nALICE: Unlock Modo Libre for unlimited practice — same Alice voice, 24/7.",
      evaluation: {
        overall_score: 74,
