...
(function (global) {
  ...
  var CANON_BY_COLUMN = {
    ...
    progressive: { id: 'gerundio', path: 'assets/canon/gerundio.svg', title: 'Clase 009 · TO BE + ING' },
    perfect: { id: 'verbos-perfecto', path: 'assets/canon/verbos-perfecto.svg', title: 'Módulo 4 — Perfecto HAVE/HAS/HAD + BEEN+ING' },
    combined: { id: 'verbos-perfecto', path: 'assets/canon/verbos-perfecto.svg', title: 'Módulo 4 — BEEN + ING' },
    ...
    modales: { id: 'will-would', path: 'assets/canon/will-would.svg', title: 'Clase 010 · WILL / WOULD y modales' },
    ...
    prepositions_time: { id: 'preposiciones-tiempo', path: 'assets/canon/preposiciones.svg', title: 'Clase 011 · Prep. de tiempo' },
    gerundio: { id: 'gerundio', path: 'assets/canon/gerundio.svg', title: 'Clase 009 · Gerundio TO vs ING' },
    gerund_prep: { id: 'gerundio', path: 'assets/canon/gerundio.svg', title: 'Clase 009 · Preposición + ING' },
