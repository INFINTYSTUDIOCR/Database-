...
var NEXORA_SCENARIO_LIBRARY = (function () {
  ...
  var stakeholder = [
    ...
    { id: 'sh-fin-roi', type: 'stakeholder', industry: 'Corporate', title: 'Financial Analysis Presentation — ROI Review', desc: 'Present your financial analysis and project ROI to a skeptical finance stakeholder. Explain numbers clearly, defend assumptions, and earn approval or face rejection.', mood: 'skeptical', diff: 5, role: 'VP of Finance', company: 'Meridian Holdings', participants: ['You — Project Lead', 'Diana Morales — VP of Finance (skeptical)', 'James Okonkwo — Strategy Advisor'], stakes: ['Finance will only approve if ROI is clear and defensible', 'Weak explanations or vague numbers lead to rejection', 'Stakeholder evaluates clarity of expression and ROI narrative'], allowPDF: true, pdfPrompt: 'You are Diana Morales, VP of Finance. The candidate uploaded a financial document. Read it carefully. Challenge ROI assumptions, payback period, risks and clarity of explanation. At the end of the meeting you MUST decide: APPROVE the project, REJECT it, or REQUEST REVISION — and say so explicitly.' }
  ];
