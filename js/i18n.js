(function () {
  ...
  var INDEX = [
    ...
    { s: '#success-stories .section-sub', en: 'Public-sector partnerships with measurable employability outcomes — reported in official municipal transparency documents.', es: 'Alianzas con sector público y resultados de empleabilidad medibles — reportados en documentos oficiales de transparencia municipal.' },
    { s: '#success-stories .success-badge', en: 'Public sector · Goicoechea · 2021', es: 'Sector público · Goicoechea · 2021' },
    { s: '#success-stories .success-card h3', en: 'Municipalidad de Goicoechea — Call Center Readiness Pilot', es: 'Municipalidad de Goicoechea — Piloto de Preparación para Call Center' },
    { s: '#success-stories .success-card > p', en: 'Infinity Studio led a strategic training alliance with the Municipality of Goicoechea: free English preparation for canton residents targeting call-center interviews and direct job placement — financed as a private-sector pilot with zero cost to beneficiaries.', es: 'Infinity Studio lideró una alianza estratégica con la Municipalidad de Goicoechea: preparación gratuita en inglés para residentes del cantón, orientada a entrevistas en call center y colocación laboral directa — financiada como piloto del sector privado sin costo para beneficiarios.' },
    ...
    { s: '#success-stories .success-links a:nth-child(3)', html: true, en: '<i class="ti ti-player-play"></i> Watch program coverage (video) <i class="ti ti-external-link" style="font-size:12px;"></i>', es: '<i class="ti ti-player-play"></i> Ver cobertura del programa (video) <i class="ti ti-external-link" style="font-size:12px;"></i>' },
    { s: '#success-stories .success-source', en: 'Metrics cited from the Municipality’s Informe de Labores 2022, section “Cursos de inglés preparatorios para call center”.', es: 'Métricas citadas del Informe de Labores 2022 de la Municipalidad, sección “Cursos de inglés preparatorios para call center”.' },
