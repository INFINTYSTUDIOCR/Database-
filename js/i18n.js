(function () {
  ...
  var INDEX_MORE = [
    ...
    { s: '#core-programs a.program-card:nth-of-type(3) .program-badge', en: 'Sister · Spanish', es: 'Sister · Español' },
    { s: '#core-programs a.program-card:nth-of-type(3) h3', en: 'GOSpanol — Spanish for foreigners', es: 'GOSpanol — Español para extranjeros' },
    { s: '#core-programs a.program-card:nth-of-type(3) p', en: 'For anglophones who freeze in Spanish. Live trainer + Vale + Training Book. Stop studying. Start speaking.', es: 'Para anglófonos que se traban en español. Trainer en vivo + Vale + Training Book. Stop studying. Start speaking.' },
    { s: '#core-programs a.program-card:nth-of-type(3) .card-cta', html: true, en: '<i class="ti ti-arrow-right"></i> View GOSpanol', es: '<i class="ti ti-arrow-right"></i> Ver GOSpanol' },
    ...
    { s: '.nav-drop-menu a[href="gospanol.html"]', en: 'GOSpanol', es: 'GOSpanol' },
