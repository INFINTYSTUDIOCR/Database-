(function () {
  ...
  var INDEX = [
    ...
    { s: '#donde-estas .section-sub', en: 'Three clear paths. Same promo price. Choose where it hurts today.', es: 'Tres caminos claros. Mismo precio promo. Elige según dónde te duele hoy.' },
    ...
    { s: '#donde-estas .who-more a', en: 'See documented Goicoechea case →', es: 'Ver caso Goicoechea documentado →' },
    ...
    { s: '#pricing .pricing-home-legal', en: 'Regular price ₡75,000/month (Fundamentos estructurales (Foundations) & ORT) or ₡75,000/30 days (Nexora Pro). Promo subject to availability · 90-min diagnostic, no commitment.', es: 'Precio regular ₡75.000/mes (Fundamentos estructurales (Foundations) y ORT) o ₡75.000/30 días (Nexora Pro). Promo sujeta a cupos · diagnóstico 90 min sin compromiso.' },
