(function () {
  ...
  var INDEX = [
    ...
    { s: '#success-stories .success-video-note', html: true, en: 'Official municipal coverage · <strong>TU506</strong> (Training United 506) is our legacy name — today <strong>Infinity Studio CR</strong> · Program led by <strong>Prof. John</strong>', es: 'Cobertura municipal oficial · <strong>TU506</strong> (Training United 506) es nuestro nombre anterior — hoy <strong>Infinity Studio CR</strong> · Programa liderado por el <strong>Prof. John</strong>' },
    { s: '#success-stories .success-legacy-note', html: true, en: '<strong>TU506 → Infinity Studio CR.</strong> Training United 506 (TU506) was our name when this municipal alliance ran in 2021 — same methodology, same founder. <strong>Prof. John</strong> designed and led the program as head instructor.', es: '<strong>TU506 → Infinity Studio CR.</strong> Training United 506 (TU506) era nuestro nombre cuando corrió esta alianza municipal en 2021 — misma metodología, mismo fundador. El <strong>Prof. John</strong> diseñó y lideró el programa como instructor principal.' },
    ...
    { s: '.success-showcase--kamuk h3', en: 'Kamuk School — Operational English Pilot', es: 'Kamuk School — Piloto de Inglés Operacional' },
    { s: '.success-showcase--kamuk .success-resume', html: true, en: 'Institutional pilot with <strong>Kamuk School</strong> (Tibás, San José) — a bilingual neuroeducational institution with more than three decades of integral education. Infinity Studio CR integrated its operational English system into Kamuk\'s secondary track: KPI-based performance measurement, personalized Training Book paths, and Alice &amp; Jill AI coaching — aligned with Kamuk\'s natural communicative approach, led by <strong>Prof. John</strong>.', es: 'Piloto institucional con <strong>Kamuk School</strong> (Tibás, San José) — institución bilingüe neuroeducativa con más de tres décadas de educación integral. Infinity Studio CR integró su sistema de inglés operacional al track secundario de Kamuk: medición KPI, rutas personalizadas en Training Book y coaching con Alice &amp; Jill — alineado al enfoque comunicativo natural de Kamuk, liderado por el <strong>Prof. John</strong>.' },
    { s: '.success-showcase--kamuk .success-features li:nth-child(1) span', en: '5 operational KPIs tracked per student — same framework as BPO readiness, adapted for institutional cohorts', es: '5 KPIs operacionales por estudiante — mismo marco que preparación BPO, adaptado a cohortes institucionales' },
    { s: '.success-showcase--kamuk .success-features li:nth-child(2) span', en: 'Training Book + Student Portal for pilot cohort — exercises rotated by trainer and Engine', es: 'Training Book + Portal del estudiante para la cohorte piloto — ejercicios rotados por trainer e Engine' },
    { s: '.success-showcase--kamuk .success-features li:nth-child(3) span', en: 'Alice & Jill available for structured practice between classroom sessions', es: 'Alice & Jill disponibles para práctica estructurada entre sesiones de aula' },
    { s: '.success-showcase--kamuk .success-features li:nth-child(4) span', en: 'Institutional track in Infinity Engine — dedicated cohort management (KAM- students)', es: 'Track institucional en Infinity Engine — gestión dedicada de cohorte (estudiantes KAM-)' },
    ...
    { s: '.success-showcase--kamuk .success-source', en: 'Pilot partnership — Infinity operational methodology inside an established bilingual school environment.', es: 'Alianza piloto — metodología operacional Infinity dentro de un colegio bilingüe consolidado.' },
