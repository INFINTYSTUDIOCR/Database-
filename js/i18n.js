(function () {
  ...
  var INDEX = [
    { s: '.hero-mirror-hope', en: 'The English you have is enough — in Mexico, Chile, Colombia or wherever you are. We take you where you need to operate.', es: 'El inglés que tienes alcanza — en México, Chile, Colombia o donde estés. Nosotros te llevamos a donde necesitas operar.' },
    { s: '.hero-tagline', en: '12 h/month private trainer · AI support · online for all LATAM', es: '12 h/mes trainer privado · IA de apoyo · online para toda LATAM' },
    { s: '.hero-headline', en: 'You don\'t need more English classes. You need to stop freezing.', es: 'No necesitas más clases de inglés. Necesitas dejar de paralizarte.' },
    { s: '.hero-pills .pill:nth-child(1)', en: '12 h private trainer', es: '12 h trainer privado' },
    { s: '.hero-pills .pill:nth-child(2)', en: 'AI between sessions', es: 'IA entre sesiones' },
    { s: '.hero-pills .pill:nth-child(3)', en: '5 KPIs / week', es: '5 KPIs / semana' },
    { s: '.hero-ctas .btn-primary', en: 'Book diagnostic', es: 'Agenda diagnóstico' },
    { s: '.hero-ctas a[href="try-alice.html"]', en: 'Alice Companion free', es: 'Alice Companion gratis' },
    ...
    { s: '#elegi-tu-vida .who-more a', en: 'Alice Companion free →', es: 'Alice Companion gratis →' },
    { s: '#donde-estas .section-tag', en: 'Your level', es: 'Tu nivel' },
    { s: '#donde-estas .section-title', html: true, en: 'Where are <span style="color:var(--purple)">you?</span>', es: '¿Dónde estás <span style="color:var(--purple)">tú?</span>' },
    { s: '#donde-estas .who-grid a:nth-child(1) h3', html: true, en: '<i class="ti ti-seedling"></i> Starting from zero', es: '<i class="ti ti-seedling"></i> No arranco' },
    { s: '#donde-estas .who-grid a:nth-child(2) h3', html: true, en: '<i class="ti ti-bolt"></i> I freeze when I speak', es: '<i class="ti ti-bolt"></i> Me bloqueo al hablar' },
    { s: '#donde-estas .who-grid a:nth-child(3) h3', html: true, en: '<i class="ti ti-microphone"></i> Need volume practice', es: '<i class="ti ti-microphone"></i> Necesito volumen' },
    { s: '#donde-estas .who-more a', en: 'Goicoechea case →', es: 'Caso Goicoechea →' },
    ...
    { s: '#pricing .section-title', html: true, en: 'Promo <span style="color:var(--purple)">₡67,500</span> · 2026', es: 'Promo <span style="color:var(--purple)">₡67.500</span> · 2026' },
    { s: '#pricing .section-sub', en: 'You picked a path above — each plan includes 12 h/month private trainer + AI support. Full breakdown on the pricing page.', es: 'Elegiste un camino arriba — cada plan incluye 12 h/mes con trainer privado + IA de apoyo. El desglose completo está en precios.' },
    { s: '#pricing .pricing-home-actions .btn-primary', html: true, en: '<i class="ti ti-tags"></i> See full plans', es: '<i class="ti ti-tags"></i> Ver planes completos' },
    ...
    { s: '#pricing .pricing-home-legal', en: 'Regular price ₡75,000/month (Núcleo & ORT) or ₡75,000/30 days (Nexora Pro). Promo subject to availability · 90-min diagnostic, no commitment.', es: 'Precio regular ₡75.000/mes (Núcleo y ORT) o ₡75.000/30 días (Nexora Pro). Promo sujeta a cupos · diagnóstico 90 min sin compromiso.' },
    ...
    { s: '#who-its-for .who-card:nth-child(3) a', en: 'Foundations →', es: 'Foundations →' },
    ...
    { s: '#programs .section-sub', en: 'Núcleo and ORT are the backbone. Off The Clock, El Conversatorio and Job Finder are community and employability satellites.', es: 'Núcleo y ORT son la columna vertebral. Off The Clock, El Conversatorio y Job Finder son satélites de comunidad y empleabilidad.' },
    ...
    { s: '#community-programs .programs-split-head p:first-of-type', en: 'Satellite initiatives — not Núcleo or ORT.', es: 'Iniciativas satélite — no son Núcleo ni ORT.' },
    { s: '#community-programs .programs-note', en: 'Purpose: community building, visibility, engagement, exposure and employability support.', es: 'Comunidad, visibilidad, práctica en vivo y apoyo en empleabilidad — complementan, no reemplazan, Núcleo ni ORT.' },
  ...
  var INDEX_MORE = [
    ...
    { s: '#panel-jill .deliverable-intro h3', en: 'Jill — Núcleo Tutor', es: 'Jill — Tutora del programa Núcleo' },
    ...
    { s: '#panel-jill .deliverable-feat:nth-child(1) span', en: 'Núcleo track — async tutor', es: 'Ruta Núcleo — tutora asíncrona' },
    ...
    { s: '#panel-jill .btn-secondary', html: true, en: '<i class="ti ti-book"></i>Núcleo program', es: '<i class="ti ti-book"></i>Programa Núcleo' },
    ...
    { s: '.jill-badge', html: true, en: '<i class="ti ti-message-circle"></i>Núcleo · Step 1', es: '<i class="ti ti-message-circle"></i>Núcleo · Paso 1' },
    { s: '.jill-title', en: 'Meet Jill — Your Núcleo Tutor', es: 'Conoce a Jill — tutora del programa Núcleo' },
    ...
    { s: '#jill .alice-cap:nth-child(4)', html: true, en: '<i class="ti ti-check"></i>Núcleo track', es: '<i class="ti ti-check"></i>Ruta Núcleo' },
    ...
    { s: '#jill a[href="foundations.html"]', html: true, en: '<i class="ti ti-book"></i>Núcleo program', es: '<i class="ti ti-book"></i>Programa Núcleo' },
    ...
    { s: '#core-programs a.program-card:nth-of-type(1) h3', en: 'Núcleo', es: 'Núcleo' },
    ...
    { s: '.nav-drop-menu a[href="foundations.html"]', en: 'Núcleo', es: 'Núcleo' },
