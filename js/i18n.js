(function () {
  ...
  var INDEX = [
    ...
    { s: '#trust-proof .trust-bar-lead', html: true, en: '<strong>10</strong> documented placements · Goicoechea pilot 2021', es: '<strong>10</strong> colocaciones documentadas · piloto Goicoechea 2021' },
    { s: '#trust-proof .trust-bar-proof', en: 'Labors Report 2022, p. 34 · verifiable municipal citation', es: 'Informe de Labores 2022, p. 34 · cita municipal verificable' },
    { s: '#trust-proof a[href="casos-de-exito.html"]', en: 'See official case →', es: 'Ver caso oficial →' },
    { s: '#trust-proof a[href*="nexora"]', en: 'Request Nexora demo', es: 'Pedir demo Nexora' },
    ...
    { s: '#panel-nexora .btn-gold-dark', html: true, en: '<i class="ti ti-calendar"></i>Request demo', es: '<i class="ti ti-calendar"></i>Solicitar demo' },
    ...
    { s: '#panel-alice .btn-primary', html: true, en: '<i class="ti ti-calendar"></i>Request demo', es: '<i class="ti ti-calendar"></i>Solicitar demo' },
    ...
    { s: '#who-its-for .who-card:nth-child(5) a', en: 'Kamuk case →', es: 'Caso Kamuk →' },
    ...
    { s: '#success-stories .section-sub', en: 'Public-sector and institutional pilots with measurable outcomes — official reports, verifiable school or municipality sites. Not marketing claims.', es: 'Pilotos del sector público e institucionales con resultados medibles — informes oficiales, sitios verificables del colegio o municipalidad. Sin promesas de marketing.' },
    { s: '.success-showcase--goicoechea .success-badge', en: 'Public sector · Goicoechea · 2021', es: 'Sector público · Goicoechea · 2021' },
    { s: '.success-showcase--goicoechea .success-document h3', en: 'Municipalidad de Goicoechea — Call Center Readiness Pilot', es: 'Municipalidad de Goicoechea — Piloto de Preparación para Call Center' },
    ...
    { s: '.success-showcase--kamuk .success-disclaimer', html: true, en: '<strong>Not a marketing claim.</strong> Unlike Goicoechea, we do not publish hire counts without an institutional source. What is verifiable: Kamuk School\'s official site and the ORT pilot Infinity integrated into the school environment.', es: '<strong>No es claim de marketing.</strong> A diferencia de Goicoechea, no publicamos cifras de contratación sin fuente institucional. Lo verificable: sitio oficial de Kamuk School y el piloto ORT que Infinity integró al entorno escolar.' },
    { s: '.success-showcase--kamuk .success-resume', html: true, en: 'Institutional <strong>Operational Readiness Training (ORT)</strong> pilot with <strong>Kamuk School</strong> (Tibás, San José) — focused on high-performance bilingual employability, not classroom English. Infinity Studio CR integrated ORT into Kamuk\'s environment: execution under pressure, KPI-driven feedback, Training Book paths, and Alice &amp; Nexora simulations — aligned with Kamuk\'s bilingual neuroeducational model, led by our founder.', es: 'Piloto institucional de <strong>Operational Readiness Training (ORT)</strong> con <strong>Kamuk School</strong> (Tibás, San José) — enfocado en empleabilidad bilingüe de alto desempeño, no inglés de aula. Infinity Studio CR integró ORT al entorno de Kamuk: ejecución bajo presión, feedback KPI, rutas en Training Book y simulaciones con Alice y Nexora — alineado al modelo bilingüe neuroeducativo del colegio, liderado por nuestro fundador.' },
    ...
    { s: '.success-showcase--kamuk .success-links a:nth-child(1)', html: true, en: '<i class="ti ti-file-description"></i> Full documented case <i class="ti ti-arrow-right" style="font-size:12px;"></i>', es: '<i class="ti ti-file-description"></i> Caso completo documentado <i class="ti ti-arrow-right" style="font-size:12px;"></i>' },
    { s: '.success-showcase--kamuk .success-links a:nth-child(2)', html: true, en: '<i class="ti ti-school"></i> Kamuk School — official site <i class="ti ti-external-link" style="font-size:12px;"></i>', es: '<i class="ti ti-school"></i> Kamuk School — sitio oficial <i class="ti ti-external-link" style="font-size:12px;"></i>' },
    { s: '.success-showcase--kamuk .success-links a:nth-child(3)', html: true, en: '<i class="ti ti-world"></i> Bilingual program · Integral education <i class="ti ti-external-link" style="font-size:12px;"></i>', es: '<i class="ti ti-world"></i> Programa bilingüe · Educación integral <i class="ti ti-external-link" style="font-size:12px;"></i>' },
    { s: '.success-showcase--kamuk .success-source', en: 'ORT institutional partnership — verifiable sources at kamukschool.ed.cr. No invented employment metrics.', es: 'Alianza institucional ORT — fuentes verificables en kamukschool.ed.cr. Sin métricas de empleo inventadas.' },
    ...
    { s: '.contact-form .form-group:has(#cf-phone) .form-label', en: 'WhatsApp', es: 'WhatsApp' },
    { s: '#cf-phone', attr: 'placeholder', en: '+52, +56, +57…', es: '+52, +56, +57…' },
    { s: '.contact-form .form-group:has(#cf-program) .form-label', en: 'Program of interest', es: 'Programa de interés' },
    { s: '.contact-form .form-group:has(#cf-goal) .form-label', en: 'Your goal', es: 'Tu meta' },
  ...
  var INDEX_MORE = [
    ...
    { s: '#panel-jill .btn-primary', html: true, en: '<i class="ti ti-calendar"></i>Request demo', es: '<i class="ti ti-calendar"></i>Solicitar demo' },
    ...
    { s: '#jill a[href="hablemos.html?solicitar=jill#consulta"]', html: true, en: '<i class="ti ti-calendar"></i>Request demo', es: '<i class="ti ti-calendar"></i>Solicitar demo' },
