(function () {
  ...
  var INDEX = [
    ...
    { s: '#panel-training-book .tb-preview:nth-child(1) .tb-preview-label', en: 'KPI Dashboard', es: 'Panel de KPIs' },
    { s: '#panel-training-book .tb-preview:nth-child(2) .tb-preview-label', en: 'Assigned Exercises', es: 'Ejercicios Asignados' },
    { s: '#panel-training-book .tb-preview:nth-child(3) .tb-preview-label', en: 'Alice In Platform', es: 'Alice en la Plataforma' },
    { s: '#panel-training-book .deliverable-actions .btn-secondary:nth-child(1)', en: 'Open live Training Book', es: 'Abrir Training Book en vivo' },
    { s: '#panel-training-book .deliverable-actions .btn-secondary:nth-child(2)', en: 'Student Portal preview', es: 'Vista previa del Portal' },
    { s: '#panel-training-book .tb-approve-banner p', en: 'Review your sample Training Book layout, exercises and Alice integration — then tell us if this is the system you want for your team or institution.', es: 'Revisá el diseño de tu Training Book, los ejercicios y la integración con Alice — y contanos si este es el sistema que querés para tu equipo o institución.' },
    { s: '#panel-training-book .tb-approve-banner .btn-primary', en: 'Approve from here', es: 'Aprobar desde aquí' },
