(function () {
  ...
  var INDEX = [
    ...
    { s: '#success-stories .success-links a:nth-child(3)', html: true, en: '<i class="ti ti-brand-facebook"></i> Open video on Facebook <i class="ti ti-external-link" style="font-size:12px;"></i>', es: '<i class="ti ti-brand-facebook"></i> Abrir video en Facebook <i class="ti ti-external-link" style="font-size:12px;"></i>' },
