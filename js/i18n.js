(function () {
  ...
  var INDEX = [
    ...
    { s: '.hero-seo', en: 'English interview training in Costa Rica — AI coaching and real simulations.', es: 'Entrenamiento para entrevistas en inglés en Costa Rica con IA y simulaciones reales.' },
    { s: '.hero-pills .pill:nth-child(1)', en: 'Private 1-on-1 Sessions', es: 'Sesiones Privadas 1 a 1' },
    { s: '.hero-pills .pill:nth-child(2)', en: 'Interview Simulations', es: 'Simulaciones de Entrevistas' },
    { s: '.hero-pills .pill:nth-child(3)', en: 'Built for Your Pain Point', es: 'Diseñado para Tu Dolor' },
    { s: '.hero-pills .pill:nth-child(4)', en: 'AI + Human Coaching', es: 'Coaching IA + Humano' },
    { s: '.hero-pills .pill:nth-child(5)', en: 'Real-Time KPI Tracking', es: 'KPIs en Tiempo Real' },
    ...
    { s: '.human-strip .human-card:nth-child(1) figcaption', html: true, en: '<strong>Private coaching</strong>Real pressure, real feedback — not a crowded classroom.', es: '<strong>Coaching privado</strong>Presión real, feedback real — no un aula llena.' },
    { s: '.human-strip .human-card:nth-child(2) figcaption', html: true, en: '<strong>Confidence building</strong>Practice until responding in English feels natural.', es: '<strong>Confianza</strong>Practicá hasta que responder en inglés se sienta natural.' },
    { s: '.human-strip .human-card:nth-child(3) figcaption', html: true, en: '<strong>Live participation</strong>Simulations, voice, mic — the same tools you use on the job.', es: '<strong>Participación en vivo</strong>Simulaciones, voz, micrófono — las mismas herramientas del trabajo.' },
