...
(function initNexoraCharacterRotation(){
  try {
    if(localStorage.getItem('nexora_next_char_rotate_v') !== '2'){
      _nxCharRotateIdx = 0;
      localStorage.setItem('nexora_next_char_rotate_v', '2');
      localStorage.setItem('nexora_next_char_rotate_idx', '0');
    } else {
      _nxCharRotateIdx = parseInt(localStorage.getItem('nexora_next_char_rotate_idx')||'0',10)||0;
    }
  } catch(e){}
})();
...
function pickNextNexoraCharacter(){
  ...
  try { localStorage.setItem('nexora_next_char_rotate_idx', String(_nxCharRotateIdx)); } catch(e){}
