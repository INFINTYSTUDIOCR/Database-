...
**Regla:** explico P, V, C (y M cuando toque) la primera vez. Cada **tiempo verbal** se explica la primera vez con su formula en whiteboard. Despues corrijo por ranura: "Esto es MSIÆ ù ˝que ranura falta?"

### Ranuras (cimientos ù explicar al inicio)

| Ranura | Significa | Ejemplo |
|--------|-----------|---------|
| **P** | **Pronombre** ù quien hace | I, you, he, she |
| **V** | **Verbo** ù la accion; la **forma** cambia segun el tiempo (presente, pasado, participio) | go / went / gone |
| **C** | **Complemento** ù el resto de la idea | home, yesterday, the book |
| **M** | **Modal** ù will, would, should, can... (solo cuando hay modal, entre P y V) | I **will** go |
...
**Modales ù no es otra categoria aparte:** modales **son** la estructura **P + M + V + C**.
...
**Puente base:** *Yo voy a casa* = P (yo) + V (voy) + C (a casa) ù misma logica en ingles: `I | go | home`.
...
6. **Combinaciùn MSI˝** ù agrego una ranura nueva. El estudiante combina. La complejidad crece natural.
...
**Logica:** en espanol ya sabe quien habla (yo, tu, el). En ingles la misma idea se divide en 4 piezas segun la funcion ˝ la ranura **P** del MSIÆ. ˝ no es una sola palabra como en espanol.
...
**Instalacion MSIÆ (obligatorio antes del primer P+V+C):** explicar que **P** = pronombre (001-B), **V** = verbo (los 16), **C** = complemento ˝ ejemplo whiteboard `I | have | a car`. Si no lo explique antes, lo hago AHORA antes de continuar.
...
8. Combinaciùn MSI˝ ù estructuras encadenadas en tiempo real.
...
- Tratar cada estructura como una ranura MSI˝.
...
5. Combinaciùn Estructura MSI˝: go ? went ? have gone ? had gone ? will have gone ? would have gone ? have been going (con 5 verbos diferentes).

**Dominio:** pasado y participio de los 16 <1s ù identifica el grupo ù completa las tres columnas desde cualquier forma ù usa ancla correcta ù combina irregulares con modales con MSI˝ ù nunca -ED a un irregular ù distingue pasado simple de participio por contexto.
...
```
Estructura MSI˝: `P + V + adj-er + THAN + C` ˝ `P + V + THE + adj-est + C`

**Regla 2 ˝ adjetivo LARGO (3+ silabas): pieza delante**
```
important -> more important -> the most important
```
Estructura MSI˝: `P + V + MORE + adj + THAN + C` ˝ `P + V + THE MOST + adj + C`
