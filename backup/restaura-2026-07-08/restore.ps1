# Restaura — punto de guardado 2026-07-08 (Learning DJ + analisis de clases grabadas)
...
Write-Host "Restaurando desde backup restaura-2026-07-08..."
...
Write-Host "Listo. Archivos restaurados al punto del 2026-07-08."
