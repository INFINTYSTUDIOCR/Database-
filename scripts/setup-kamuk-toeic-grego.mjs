...
async function main() {
  ...
  const roster = {
    ...
    name: GREGO.name,
    email: GREGO.email,
    exp: 'Trainer · Kamuk TOEIC Seniors · práctica y conexión de su cohorte',
    bio: 'Trainer de la cohorte TOEIC Undécimo (Seniors). Ve práctica y conexiones de sus estudiantes asignados. Master: solo Johnny.',
    nexoraEnabled: true,
    fullEngagement: true,
    canViewPractice: true,
    canViewConnectionTime: true
