  ...
  "alice": {
    ...
    "finish": {
      ...
      "evaluation": {
        "overall_score": 72,
        "highlights": [
          "You completed the demo session",
          "You attempted extended responses in English"
        ],
        "improvements": [
          "Practice Idea + Linker + Idea structure",
          "Use connectors: however, on top of that, even though"
        ],
        "connectors_found": [],
        "connectors_suggested": [
          "however",
          "on top of that",
          "even though",
          "therefore"
  ...
  "jill": {
    ...
    "finish": {
      ...
      "evaluation": {
        "overall_score": 70,
        "highlights": [
          "You completed the Jill demo",
          "You attempted structured responses"
        ],
        "improvements": [
          "Practice because/however in every answer",
          "Keep answers to Idea + Linker + Idea"
        ],
        "connectors_found": [],
        "connectors_suggested": [
          "because",
  ...
  "nexora_star": {
    ...
    "finish": {
      ...
      "evaluation": {
        ...
        "structure_score": 65,
        "wins": [
          "You completed the STAR demo",
          "You attempted structured answers under interview pressure"
        ],
        "improvements": [
          "Name YOUR specific action in each story",
  ...
  "nexora_cs": {
    ...
    "finish": {
      ...
      "evaluation": {
        ...
        "wins": [
          "You stayed in the call",
          "You attempted to address the client's concern"
        ],
        "improvements": [
          "Acknowledge emotion first before explaining policy",
          "Use empathy phrases: \"I understand how frustrating this is\"",
          "Offer a clear next step with a timeline"
        ],
