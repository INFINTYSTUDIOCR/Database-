/**
 * Jill Pro Premium — Stripe Checkout standby (clone Alice Companion pattern).
...
function publicConfig() {
  ...
  return {
    ...
    crcHint: '?12.500 · Jill Pro 30 días',
    features: [
      'Jill Pro Companion ilimitada (30 días)',
      'Modo libre ? lección MSI (regla + canon + práctica)',
      'Activación por WhatsApp (mismo día)',
      'Voz + micrófono',
      'Recuperá acceso con tu email'
    ],
    whatsapp: 'https://wa.me/50660060981?text=' + encodeURIComponent(
      'Hola! Quiero Jill Pro Premium (?12.500 / 30 días).\nMi email para activar: '
    ),
    plugEnv: [
      'STRIPE_SECRET_KEY',
