...
ok(
  'Q18 hub VER hub46 + portal query + sw v91 + game shell no-store',
  /20260812hub46/.test(hub) &&
    /infinity-casino-floor\.js\?v=20260812hub46/.test(portal) &&
    /infinity-pwa-v91/.test(sw) &&
    /isGameShell/.test(sw) &&
...
console.log(
  'Core checks green. Knight + Thief finishable; Tense Raiders proto; verify: hub46'
);
