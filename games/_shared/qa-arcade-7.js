...
ok(
  'Q18 hub VER hub41 + portal query + sw v86 + game shell no-store',
  /20260812hub41/.test(hub) &&
    /infinity-casino-floor\.js\?v=20260812hub41/.test(portal) &&
    /infinity-pwa-v86/.test(sw) &&
    /isGameShell/.test(sw) &&
...
console.log(
  'Core checks green. Knight + Thief finishable; Tense Raiders proto; verify: hub41'
);
