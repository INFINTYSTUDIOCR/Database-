...
ok(
  'Q18 hub VER hub45 + portal query + sw v90 + game shell no-store',
  /20260812hub45/.test(hub) &&
    /infinity-casino-floor\.js\?v=20260812hub45/.test(portal) &&
    /infinity-pwa-v90/.test(sw) &&
    /isGameShell/.test(sw) &&
...
console.log(
  'Core checks green. Knight + Thief finishable; Tense Raiders proto; verify: hub45'
);
